...
{
	public partial class Flash : PositionedObject, IDestroyable
	{
        ...
        public Flash(string contentManagerName, bool addToManagers) :
			base()
		{
			// Don't delete this:
...
// Generated AddToManagers
		...
		public virtual void PostInitialize ()
		{
			...
			SpriteInstance.TextureScale = 4f;
		...
		public virtual void AssignCustomVariables (bool callOnContainedElements)
		{
			...
			mSpriteInstance.Texture = White_square;
			mSpriteInstance.TextureScale = 4f;
			Visible = false;
			Alpha = 0f;
		}
		...
		public static void LoadStaticContent (string contentManagerName)
		{
			...
			if (LoadedContentManagers.Contains(contentManagerName) == false)
			{
				...
				lock (mLockObject)
				{
					...
					{
						FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("FlashStaticUnload", UnloadStaticContent);
